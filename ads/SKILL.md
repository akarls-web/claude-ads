...
4. Run SterlingX custom checks (SX01-SX15) from `references/sterlingx-checks.md`
...
7. Apply SterlingX branded report template (header, next steps, engagement path)

For individual commands (`/ads google`, `/ads meta`, etc.), load the relevant
sub-skill directly.

## SterlingX Report Branding

All audit reports generated by this skill must include:
- **Header**: SterlingX agency branding with report ID (SX-ADS-[YYYYMMDD]-[SEQ])
- **Footer**: SterlingX next steps and engagement path
- **Methodology note**: "190 base checks + 15 SterlingX agency checks"
- **Client-ready language**: Professional, actionable, non-technical executive summary
...
- `references/sterlingx-checks.md` — 15 SterlingX agency custom checks (SX01-SX15)
